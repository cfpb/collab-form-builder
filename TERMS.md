...
- [Bootstrap Libraries](src/form_builder/static/js/bootstrap-afix.js) are released under the Apache license
- [Underscore.js](src/form_builder/static/js/underscore.js) is released under the MIT license