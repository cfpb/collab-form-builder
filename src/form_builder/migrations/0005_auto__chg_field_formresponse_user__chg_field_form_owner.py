...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FormResponse.user'
        db.alter_column(u'form_builder_formresponse', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.CollabUser'], null=True))

        # Changing field 'Form.owner'
        db.alter_column(u'form_builder_form', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.CollabUser']))

    def backwards(self, orm):

        # Changing field 'FormResponse.user'
        db.alter_column(u'form_builder_formresponse', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

        # Changing field 'Form.owner'
        db.alter_column(u'form_builder_form', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
