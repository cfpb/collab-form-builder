...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Form.date_created'
        db.add_column('form_builder_form', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 6, 6, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Form.date_created'
        db.delete_column('form_builder_form', 'date_created')
