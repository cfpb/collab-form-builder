...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FormResponse.archived'
        db.add_column('form_builder_formresponse', 'archived',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FormResponse.archived'
        db.delete_column('form_builder_formresponse', 'archived')
