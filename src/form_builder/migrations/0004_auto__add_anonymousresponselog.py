...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'anonymousresponse'
        db.create_table(u'form_builder_anonymousresponse', (
        ...
        db.send_create_signal(u'form_builder', ['anonymousresponse'])


    def backwards(self, orm):
        # Deleting model 'anonymousresponse'
        db.delete_table(u'form_builder_anonymousresponse')
